...
const Managers = React.lazy(() => import('./views/admin/managers/Managers'))
...
const routes = [
  ...
  { path: '/admin', name: 'Users', component: Managers, exact: true },
  { path: '/admin/managers', name: 'Managers', component: Managers },
